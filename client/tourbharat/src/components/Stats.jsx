...
const Stats = () => {
  return (
    <section className={`${styles.flexCenter} flex-row flex-wrap sm:mb-20 mb-6`}>
        {
            stats.map((stat)=>(
                <div key = {stat.id} className='flex-1 flex justify-content items-center flex-rw m-3'
                >
                    ...
                    text- [15px] xs: leading-[26px] leading-[21px] text-gradient uppercase ml-4'>{stat.title}</p>
